...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post residents_url, params: { resident: { hostel_id: @resident.hostel_id, name: @resident.name, roll_number: @resident.roll_number, room_number: @resident.room_number } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { hostel_id: @resident.hostel_id, name: @resident.name, roll_number: @resident.roll_number, room_number: @resident.room_number } }
